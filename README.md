...
*   **[addtweet.js](file:///c:/project/Discord-Raid/commands/admin/addtweet.js):** নতুন রেইড এনাউন্স করার মূল কমান্ড। 
    *   *পরিবর্তনসমূহ:* এটি আপডেট করা হয়েছে যাতে সাধারণ টেক্সট ও টুইটার লিংক সহ রেইড পোস্টের ক্ষেত্রে কাস্টম এমবেড কার্ড ব্যবহার করা হয়। এর ফলে বটের প্রোফাইল পিকচার এবং ইউজারনেম সবসময় দৃশ্যমান থাকে। কন্টেন্টের নিচে সুন্দর একটি ডিভাইডার লাইন ও রেইড সাবমিট করার বাংলা নির্দেশনাবলী ও Tweet ID ফুটারের ঠিক উপরে প্রদর্শন করা হয়। টুইটার লিংকের ক্ষেত্রে নিচে FxTwitter প্রিভিউ কার্ড এবং সরাসরি রিডাইরেক্ট বাটনও যুক্ত হয়।
...
*   **[approveraid.js](file:///c:/project/Discord-Raid/commands/admin/approveraid.js):** মেম্বারদের পেন্ডিং রেইড ম্যানুয়ালি অনুমোদন করে ১০ পয়েন্ট রিওয়ার্ড দেওয়া। (অটো-অ্যাপ্রুভালের বিকল্প/ব্যাকআপ হিসেবে রাখা হয়েছে)।
*   **[rejectraid.js](file:///c:/project/Discord-Raid/commands/admin/rejectraid.js):** ভুল বা ইনভ্যালিড রেইড বাতিল করা এবং বাতিলকরণের কারণ জানিয়ে মেম্বারকে ইনবক্স করা।
...
*   **[addwlitem.js](file:///c:/project/Discord-Raid/commands/admin/addwlitem.js):** পয়েন্ট শপ বা মার্কেটপ্লেসে নতুন গিফট/হোয়াইটলিস্ট আইটেম যুক্ত করা।
*   **[removewlitem.js](file:///c:/project/Discord-Raid/commands/admin/removewlitem.js):** শপ থেকে নির্দিষ্ট আইটেম মুছে ফেলা।
...
*   **[submitraid.js](file:///c:/project/Discord-Raid/commands/user/submitraid.js):** মেম্বারদের রেইডের লিংক সাবমিট করার কমান্ড। 
    *   *পরিবর্তনসমূহ:* ডুপ্লিকেট রেইড লিংক সাবমিশন প্রতিরোধ করে এবং একই Tweet ID তে মেম্বারদের একাধিকবার রেইড দেওয়া ব্লক করে। সফল ভ্যালিডেশনের পর সরাসরি রেইডটি `approved` করে অ্যাকাউন্টে **১০ পয়েন্ট** যোগ করে দেওয়া হয়।
...
*   **[claimwl.js](file:///c:/project/Discord-Raid/commands/user/claimwl.js):** শপ থেকে ব্যালেন্স পয়েন্ট খরচ করে আইটেম ক্লেম বা কেনা।
...
*   **[Tweet.js](file:///c:/project/Discord-Raid/database/models/Tweet.js):** ট্র্যাক করা টুইট আইডি ও লিংক সংরক্ষণের মডেল।
